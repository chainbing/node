...
coordinator in the chainbing network.
...
Pipeline and TxManager to have a copy of the current chainbing network state
...
import (
	...
	"github.com/chainbing/node/batchbuilder"
	...
	"github.com/chainbing/node/etherscan"
	"github.com/chainbing/node/log"
	"github.com/chainbing/node/prover"
	"github.com/chainbing/node/synchronizer"
	"github.com/chainbing/node/txprocessor"
	"github.com/chainbing/node/txselector"

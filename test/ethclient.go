...
func NewClientSetupExample() *ClientSetup {
	...
	tokenCB := ethCommon.HexToAddress("0x51D243D62852Bba334DD5cc33f242BAc8c698074")
	...
	rollupConstants := &common.RollupConstants{
		...
		TokenCB:                tokenCB,
		ChainbingGovernanceAddress: governanceAddress,
		ChainbingAuctionContract:   ethCommon.HexToAddress("0x8E442975805fb1908f43050c9C1A522cB0e28D7b"),
	...
	auctionConstants := &common.AuctionConstants{
		...
		TokenCB:              tokenCB,
		ChainbingRollup:          ethCommon.HexToAddress("0x474B6e29852257491cf283EfB1A9C61eBFe48369"),
	}
	auctionVariables := &common.AuctionVariables{
	...
	wDelayerConstants := &common.WDelayerConstants{
		...
		ChainbingRollup:         auctionConstants.ChainbingRollup,
	}
	wDelayerVariables := &common.WDelayerVariables{
		ChainbingGovernanceAddress:    ethCommon.HexToAddress("0xcfD0d163AE6432a72682323E2C3A5a69e6B37D12"),
...
// RollupUpdateTokensCB is the interface to call the smart contract function
// func (c *Client) RollupUpdateTokensCB(newTokenCB ethCommon.Address) (tx *types.Transaction,
// 	err error) {
// 	c.rw.Lock()
// 	defer c.rw.Unlock()
// 	cpy := c.nextBlock().copy()
...
// 	// TODO (Not defined in Chainbing.sol)
// 	return nil, errTODO
// }
...
func (c *Client) WDelayerEventInit(genesisBlockNum int64) (*eth.WDelayerEventInitialize, int64, error) {
	...
	return &eth.WDelayerEventInitialize{
		...
		InitialChainbingGovernanceAddress: vars.ChainbingGovernanceAddress,

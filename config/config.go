...
import (
	...
	"github.com/chainbing/node/priceupdater"
...
type Coordinator struct {
	...
	// FeeAccount is the Chainbing account that the coordinator uses to receive fees
	FeeAccount struct {
...
// Node is the chainbing node configuration.
type Node struct {
	PriceUpdater struct {
	...
	SmartContracts struct {
		// Rollup is the address of the Chainbing.sol smart contract

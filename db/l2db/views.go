...
type poolTxAPIView struct {
	...
	EffectiveFromEthAddr *apitypes.CbEthAddr  `meddler:"effective_from_eth_addr"`
	EffectiveFromBJJ     *apitypes.CbBJJ      `meddler:"effective_from_bjj"`
	ToIdx                *apitypes.CbIdx      `meddler:"to_idx"`
	EffectiveToEthAddr   *apitypes.CbEthAddr  `meddler:"effective_to_eth_addr"`
	EffectiveToBJJ       *apitypes.CbBJJ      `meddler:"effective_to_bjj"`
	...
	RqFromIdx            *apitypes.CbIdx      `meddler:"rq_from_idx"`
	RqToIdx              *apitypes.CbIdx      `meddler:"rq_to_idx"`
	RqToEthAddr          *apitypes.CbEthAddr  `meddler:"rq_to_eth_addr"`
	RqToBJJ              *apitypes.CbBJJ      `meddler:"rq_to_bjj"`
...
type AccountCreationAuthAPI struct {
	EthAddr   apitypes.CbEthAddr   `json:"cbEthereumAddress" meddler:"eth_addr" `
	BJJ       apitypes.CbBJJ       `json:"bjj"                meddler:"bjj" `

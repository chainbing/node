...
func (m migrationTest0009) RunAssertsAfterMigrationUp(t *testing.T, db *sqlx.DB) {
	...
	const queryUpdate = `UPDATE tx_pool SET to_eth_addr = 'cb:0x7E5F4552091A69125d5DfCb7b8C2659029395Bdf' WHERE tx_id = decode('03A193BC53932580F2EF91B5DA038AF611D9F1D896D518CDD65B1D766CBD835E30','hex')`
	_, err = db.Exec(queryUpdate)
	assert.NoError(t, err)
	const getQuery = `SELECT COUNT(*) FROM tx_pool WHERE effective_to_eth_addr = 'cb:0x7E5F4552091A69125d5DfCb7b8C2659029395Bdf'`

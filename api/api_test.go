...
import (
	...
	"github.com/chainbing/node/api/stateapiupdater"
	...
	"github.com/chainbing/node/test"
	"github.com/chainbing/node/test/til"
	"github.com/chainbing/node/test/txsets"
...
func TestMain(m *testing.M) {
	...
	constants := &historydb.Constants{
		...
		ChainID:       chainID,
		ChainbingAddress: _config.ChainbingAddress,
	}
	...
	tc = testCommon{
		...
		auths:            genTestAuths(test.GenAuths(5, _config.ChainID, _config.ChainbingAddress)),
		router:           router,
		bids:             testBids,

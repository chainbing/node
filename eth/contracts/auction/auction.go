...
func (_Auction *AuctionCaller) GetClaimableCB(opts *bind.CallOpts, bidder common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Auction.contract.Call(opts, &out, "getClaimableCB", bidder)
...
func (_Auction *AuctionSession) GetClaimableCB(bidder common.Address) (*big.Int, error) {
	return _Auction.Contract.GetClaimableCB(&_Auction.CallOpts, bidder)
}
...
func (_Auction *AuctionCaller) ChainbingRollup(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Auction.contract.Call(opts, &out, "chainbingRollup")
...
func (_Auction *AuctionSession) ChainbingRollup() (common.Address, error) {
	return _Auction.Contract.ChainbingRollup(&_Auction.CallOpts)
}
...
func (_Auction *AuctionCaller) TokenCB(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Auction.contract.Call(opts, &out, "tokenCB")
...
func (_Auction *AuctionSession) TokenCB() (common.Address, error) {
	return _Auction.Contract.TokenCB(&_Auction.CallOpts)
}
...
func (_Auction *AuctionTransactor) ClaimCB(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Auction.contract.Transact(opts, "claimCB")
}
...
func (_Auction *AuctionSession) ClaimCB() (*types.Transaction, error) {
	return _Auction.Contract.ClaimCB(&_Auction.TransactOpts)
}
...
func (_Auction *AuctionTransactor) ClaimPendingCB(opts *bind.TransactOpts, slot *big.Int) (*types.Transaction, error) {
	return _Auction.contract.Transact(opts, "claimPendingCB", slot)
}
...
func (_Auction *AuctionSession) ClaimPendingCB(slot *big.Int) (*types.Transaction, error) {
	return _Auction.Contract.ClaimPendingCB(&_Auction.TransactOpts, slot)
}
...
func (_Auction *AuctionTransactor) ChainbingAuctionProtocolInitializer(opts *bind.TransactOpts, token common.Address, genesis *big.Int, chainbingRollupAddress common.Address, _governanceAddress common.Address, donationAddress common.Address, bootCoordinatorAddress common.Address, _bootCoordinatorURL string) (*types.Transaction, error) {
	return _Auction.contract.Transact(opts, "chainbingAuctionProtocolInitializer", token, genesis, chainbingRollupAddress, _governanceAddress, donationAddress, bootCoordinatorAddress, _bootCoordinatorURL)
}
...
func (_Auction *AuctionSession) ChainbingAuctionProtocolInitializer(token common.Address, genesis *big.Int, chainbingRollupAddress common.Address, _governanceAddress common.Address, donationAddress common.Address, bootCoordinatorAddress common.Address, _bootCoordinatorURL string) (*types.Transaction, error) {
	return _Auction.Contract.ChainbingAuctionProtocolInitializer(&_Auction.TransactOpts, token, genesis, chainbingRollupAddress, _governanceAddress, donationAddress, bootCoordinatorAddress, _bootCoordinatorURL)
}
...
func (_Auction *AuctionFilterer) FilterCBClaimed(opts *bind.FilterOpts, owner []common.Address) (*AuctionCBClaimedIterator, error) {
	...
	logs, sub, err := _Auction.contract.FilterLogs(opts, "CBClaimed", ownerRule)
	if err != nil {
		return nil, err
	}
	return &AuctionCBClaimedIterator{contract: _Auction.contract, event: "CBClaimed", logs: logs, sub: sub}, nil
}
...
func (_Auction *AuctionFilterer) WatchCBClaimed(opts *bind.WatchOpts, sink chan<- *AuctionCBClaimed, owner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Auction.contract.WatchLogs(opts, "CBClaimed", ownerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(AuctionCBClaimed)
				if err := _Auction.contract.UnpackLog(event, "CBClaimed", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *AuctionInitializeChainbingAuctionProtocolEventIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(AuctionInitializeChainbingAuctionProtocolEvent)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *AuctionInitializeChainbingAuctionProtocolEventIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *AuctionInitializeChainbingAuctionProtocolEventIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_Auction *AuctionFilterer) FilterInitializeChainbingAuctionProtocolEvent(opts *bind.FilterOpts) (*AuctionInitializeChainbingAuctionProtocolEventIterator, error) {
	...
	logs, sub, err := _Auction.contract.FilterLogs(opts, "InitializeChainbingAuctionProtocolEvent")
	if err != nil {
		return nil, err
	}
	return &AuctionInitializeChainbingAuctionProtocolEventIterator{contract: _Auction.contract, event: "InitializeChainbingAuctionProtocolEvent", logs: logs, sub: sub}, nil
}
...
func (_Auction *AuctionFilterer) WatchInitializeChainbingAuctionProtocolEvent(opts *bind.WatchOpts, sink chan<- *AuctionInitializeChainbingAuctionProtocolEvent) (event.Subscription, error) {
	...
	logs, sub, err := _Auction.contract.WatchLogs(opts, "InitializeChainbingAuctionProtocolEvent")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(AuctionInitializeChainbingAuctionProtocolEvent)
				if err := _Auction.contract.UnpackLog(event, "InitializeChainbingAuctionProtocolEvent", log); err != nil {
					return err
				}
				event.Raw = log

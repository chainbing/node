...
func initTest(t *testing.T, chainID uint16, chainbingContractAddr ethCommon.Address,
...
func addAccCreationAuth(t *testing.T, tc *til.Context, txsel *TxSelector, chainID uint16,
	chainbingContractAddr ethCommon.Address, username string) []byte {
...
func TestGetL2TxSelectionMinimumFlow0(t *testing.T) {
	...
	txsel, _, stateDB := initTest(t, chainID, chainbingContractAddr, tc.Users["Coord"])
	...
	accAuthSig0 := addAccCreationAuth(t, tc, txsel, chainID, chainbingContractAddr, "B")
	accAuthSig1 := addAccCreationAuth(t, tc, txsel, chainID, chainbingContractAddr, "C")
...
func TestPoolL2TxInvalidNonces(t *testing.T) {
	...
	// add AccountCreationAuths that will be used at the next batch
	_ = addAccCreationAuth(t, tc, txsel, chainID, chainbingContractAddr, "C")
	_ = addAccCreationAuth(t, tc, txsel, chainID, chainbingContractAddr, "D")
	_ = addAccCreationAuth(t, tc, txsel, chainID, chainbingContractAddr, "E")
	_ = addAccCreationAuth(t, tc, txsel, chainID, chainbingContractAddr, "F")
	_ = addAccCreationAuth(t, tc, txsel, chainID, chainbingContractAddr, "G")
...
func TestValidTxsWithLowFeeAndInvalidTxsWithHighFee(t *testing.T) {
	...
	chainbingContractAddr := ethCommon.HexToAddress("0xc344E203a046Da13b0B4467EB7B3629D0C99F6E6")
	txsel, historyDB, stateDB := initTest(t, chainID, chainbingContractAddr, tc.Users["Coord"])
...
func TestL1UserFutureTxs(t *testing.T) {
	...
	_ = addAccCreationAuth(t, tc, txsel, chainID, chainbingContractAddr, "B")
	// add the PoolL2Txs to the l2DB
	addL2Txs(t, txsel, poolL2Txs)
...
func TestSimpleAtomicTx(t *testing.T) {
	...
	chainbingContractAddr := ethCommon.HexToAddress("0xc344E203a046Da13b0B4467EB7B3629D0C99F6E6")
	txsel, _, _ := initTest(t, chainID, chainbingContractAddr, tc.Users["Coord"])

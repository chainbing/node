...
according to the `RqOffset` spec: https://docs.chainbing.io/#/developers/protocol/chainbing-protocol/circuits/circuits?id=rq-tx-verifier
...
import (
	...
	"github.com/chainbing/node/api"
	"github.com/chainbing/node/common"
	"github.com/chainbing/node/db/kvdb"
	"github.com/chainbing/node/db/l2db"
	"github.com/chainbing/node/db/statedb"
	"github.com/chainbing/node/log"
	"github.com/chainbing/node/metric"
	"github.com/chainbing/node/txprocessor"
...
func (txsel *TxSelector) processTxToEthAddrBJJ(
	...
	*common.PoolL2Tx, *common.L1Tx, *common.AccountCreationAuth, error) {
	...
	// is supported by the Chainbing zkRollup specification, but it was decided
